...
public class DimenUtil {
    ...
    public static void main(String args[]){
        //模板
        File file = new File("E:\\liao\\dimens.xml");
        ...
        try {
            ...
            reader.close();
            //写入文件
            String sw360File = generateFile("E:\\liao\\values-sw360dp\\dimens.xml");
            String sw540File = generateFile("E:\\liao\\values-sw540dp\\dimens.xml");
